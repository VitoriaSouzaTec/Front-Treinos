...
import { getUserTrainData, getUserTrainDataResponse } from "@/app/_lib/api/fetch-generated";
...
export default async function ProfilePage() {
  ...
  const trainDataResponse: getUserTrainDataResponse = await getUserTrainData({
    headers: await headers(),
  });
  ...
  const data = trainDataResponse.data;
